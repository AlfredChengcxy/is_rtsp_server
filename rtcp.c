...
static void parse_receiver_report(uint8_t *packet, int count)
{
    ...
    xlog(LOG_INF, "[RTCP] Receiver report for %u", ssrc);
    packet+=4;
    while(count--) {
